...
func init() {
	proto.RegisterType((*Comment)(nil), "cosmonaut.blog.blog.Comment")
}
...
var fileDescriptor_7734d44b462eebbe = []byte{
	...
	0x4e, 0xce, 0x2f, 0xce, 0xcd, 0xcf, 0x4b, 0x2c, 0x2d, 0xd1, 0x03, 0xc9, 0x82, 0x09, 0xa5, 0x4a,
	0x2e, 0x76, 0x67, 0x88, 0x2a, 0x21, 0x3e, 0x2e, 0xa6, 0xcc, 0x14, 0x09, 0x46, 0x05, 0x46, 0x0d,
	0x96, 0x20, 0xa6, 0xcc, 0x14, 0x21, 0x21, 0x2e, 0x96, 0xa4, 0xfc, 0x94, 0x4a, 0x09, 0x26, 0x05,
	0x46, 0x0d, 0xce, 0x20, 0x30, 0x5b, 0x48, 0x8c, 0x8b, 0xad, 0x20, 0xbf, 0xb8, 0xc4, 0xd3, 0x45,
	0x82, 0x19, 0x2c, 0x0a, 0xe5, 0x09, 0x49, 0x70, 0xb1, 0x27, 0x17, 0xa5, 0x26, 0x96, 0xe4, 0x17,
	0x49, 0xb0, 0x80, 0x25, 0x60, 0x5c, 0xb8, 0x4c, 0x6a, 0x8a, 0x04, 0x2b, 0x92, 0x4c, 0x6a, 0x8a,
	...
	0x64, 0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0xc3, 0x1d, 0xad, 0x0f, 0xf6, 0x52, 0x05, 0x84,
	0x2a, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x7b, 0xcc, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff,
	0xd3, 0x0e, 0xce, 0x44, 0xee, 0x00, 0x00, 0x00,
}
...
func (m *Comment) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Created) > 0 {
		...
		i = encodeVarintComment(dAtA, i, uint64(len(m.Created)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Creator) > 0 {
